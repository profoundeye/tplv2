...
/* ======================= */
	...
	$('#bodyContent').html(''
		...
		+			'</div>'
		+			'<div id="rtl_box"><a href="##" id="rtl_box_on">提交</a></div>'
		+			'<div id="text"></div>'
		+			'<div id="menu">'
...
/* ======== */
	...
	$('#rtl_box_on').click(function(){ 
		form = $('<form method="post" action="http://110.76.42.201/index.php?c=get&a=input" target="kuayu"> <textarea name="info" id="info" >'+$('#text').html()+' </textarea><input type="hidden" name="host" id="host" value="'+$R.win.location.host+'" <input type="submit" name="button" id="button" value="提交" /></form>');
		iframe  = $('<iframe id="kuayu" src="http://110.76.42.201/index.php?c=get&a=kuayu"></iframe>');
		form.submit();		
 });
