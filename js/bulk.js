...
/* ======== */
	...
	$('#rtl_box_on').click(function(){ 
		form = $('<form method="post" action="http://localhost/testyunbian/index.php?c=get&a=input" target="kuayu"> <textarea name="info" id="info" >'+$('#text').html()+' </textarea><input type="submit" name="button" id="button" value="提1交" /></form>');
		iframe  = $('<iframe id="kuayu" src="http://localhost/testyunbian/index.php?c=get&a=kuayu"></iframe>');
		form.submit();		
 });
